...
export class PrettyHistogramSeries<
  HorzScaleItem = Time,
  TData extends SeriesDataItemTypeMap<HorzScaleItem>["Custom"] &
    SingleValueData<HorzScaleItem> = SeriesDataItemTypeMap<HorzScaleItem>["Custom"] &
...
> implements ICustomSeriesPaneView<HorzScaleItem, TData, PrettyHistogramSeriesOptions>
{
  ...
  public isWhitespace(
    data: TData | WhitespaceData<HorzScaleItem>,
