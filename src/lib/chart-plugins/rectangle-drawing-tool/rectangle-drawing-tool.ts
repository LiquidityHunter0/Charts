...
export class RectangleDrawingTool {
  ...
  private _buttonClickHandler: (() => void) | undefined;
  private _colorPickerChangeHandler: (() => void) | undefined;
  ...
  remove() {
    ...
    if (this._toolbarButton && this._buttonClickHandler) {
      this._toolbarButton.removeEventListener("click", this._buttonClickHandler);
    }
    if (this._colorPicker && this._colorPickerChangeHandler) {
      this._colorPicker.removeEventListener("change", this._colorPickerChangeHandler);
    }
  ...
  private _addToolbarButton() {
    ...
    this._colorPickerChangeHandler = () => {
    ...
    colorPicker.addEventListener("change", this._colorPickerChangeHandler);
